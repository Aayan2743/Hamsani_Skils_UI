...
export default function LoginPage() {
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      if (res.data?.status && res.data?.token) {
        ...
        // Use AuthProvider's login function which handles all localStorage setup
        login({ token, user });
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#F5F5DC] via-[#FFF8E7] to-[#F5F5DC] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 relative z-10">
        ...
        <div className="relative h-64 lg:h-auto overflow-hidden group">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white p-8">
            <h2 className="text-4xl font-bold mb-4 text-center drop-shadow-lg font-display">
              Welcome Back
            </h2>
        ...
        <div className="p-8 lg:p-12 flex items-center justify-center">
          <div className="w-full max-w-md space-y-6">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl font-bold text-[#2C1810] mb-2 font-display">
                Sign In
              </h1>
